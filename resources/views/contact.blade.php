    ...
    <div class="content" id="content">
        <section class="contact" id="contact">
            ...
            <form class="contactForm" id="contactForm" method="post">
                <input type="text" placeholder="Name" name='name' id="c_name" value="123">
                <input type="email" placeholder="E-mail" name='email' id="c_email" value="sdf@ffff.ru">
                <input type="text" placeholder="Subject" name='subject' id="c_subject" value="">
                <textarea name="message" placeholder="Message" id="c_message">sdfsdfdsfg</textarea>
                @csrf
